...
export default function SunriseRiversidePage() {
    const sunriseProjectId = "68df5c94dd42fb47da73daca";
    ...
    useEffect(() => {
        getProjectWithSaleProducts(sunriseProjectId).then((data) => {
    ...
    return (
        ...
        >
            ...
            <div className="sunrise-container" style={{ flex: 1 }}>
                ...
                {products.length > 0 && (
                    <>
                        <h1 className="sunrise-title">Sunrise Riverside</h1>
