...
export default function VictoriaVillagePage() {
    const victoriaProjectId = "68e31746e114ddee507232cc";
    ...
    useEffect(() => {
        getProjectWithSaleProducts(victoriaProjectId).then((data) => {
    ...
    return (
        ...
        >
            ...
            <div className="sunrise-container" style={{ flex: 1 }}>
                ...
                {products.length > 0 && (
                    <>
                        <h1 className="sunrise-title">Victoria Village</h1>
